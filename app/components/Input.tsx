...
const Input = forwardRef<InputRef, InputProps>(
  (
    ...
    const getBorderColor = () => {
      ...
      return isDarkMode ? "rgba(64, 192, 87, 0.3)" : "rgba(43, 147, 72, 0.2)";
    };
    ...
    const getPadding = () => {
      switch (size) {
        case "sm":
          return { paddingVertical: 8, paddingHorizontal: 10, fontSize: 14 };
        case "lg":
          return { paddingVertical: 16, paddingHorizontal: 18, fontSize: 18 };
        default:
        ...
        <View
          style={[
            styles.inputContainer,
            {
              ...
              borderBottomWidth:
                variant === "default" ? 1 : variant === "outline" ? 1 : 0,
            },
          ]}
        >
          ...
          <TextInput
            ...
            style={[
              styles.input,
              {
                ...
                paddingRight:
                  rightIcon || isPassword || (showClearButton && value)
                    ? 0
                    : paddingHorizontal,
                fontSize,
                color: colors.text,
